...
{	
	...
	if(this->item[id].Enabled == true)
	{
		...
		{	
				...
				gCashShop.GDCashShopSubPointSaveSend(lpObj->Index,0,Total,0,0);
				...
				{
					gNotice.GCNoticeSend(lpObj->Index,1,0,0,0,0,0,"You need more wCoinC!");
				}
		}
	else
		{
