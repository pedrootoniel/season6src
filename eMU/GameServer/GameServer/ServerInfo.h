...
public:
	...
	void LoadPetConfig();
	void ReadInstaGameInfo();
	void ReadPKEventInfo();
	...
	BYTE INVENTORY_SIZE_SCF(int aIndex, bool Max);
	BYTE WAREHOUSE_SIZE_SCF(int aIndex, bool Max);
public:
	...
	int	m_WriteInstaGamesLog;
	int	m_WriteSmithItemLog;
	int m_WriteQuestLog;
	int m_WriteItemLog;
	...
	int	m_PostItem;
	int	m_TitleBarSwitch;
	int	m_PlayerHPBarSwitch;
	int m_NonPK;
	int m_PKLimitFree;
	int m_PKDownTime1;
	int m_PKDownTime2;
	...
	int m_MaxPartyLevelDiff;
	int	m_AcceptPartyKill;
	...
	int m_KalimaMaxStand;
	int m_KalimaMaxNextStand;
	int m_KalimaMaxEnterUser;
	...
	int m_FeatherOfGarudaMixRate[MAX_ACCOUNT_LEVEL];
	int m_Wing4MixRate[MAX_ACCOUNT_LEVEL];
	int m_ArchangelHammerMix[MAX_ACCOUNT_LEVEL];
	int m_ArchangelWeaponMix[MAX_ACCOUNT_LEVEL];
	...
	int m_CommandClearINVMoney[MAX_ACCOUNT_LEVEL];

	char SurvivorMsg[23][128];
	short SurvivorMap;
	short SurvivorX1;
	short SurvivorY1;
	short SurvivorX2;
	short SurvivorY2;
	short SurvivorTimeLimit;
	char SurvivorWinnerByKillCount;
	short SurvivorMinimumPlayers;
	char SurvivorDisableTeleport;

	int m_CommandResetPoint2;
	int m_CommandResetSkill2;
	int m_CommandResetMasterSkill2;
	int m_CommandFreeSkillSwitch[MAX_ACCOUNT_LEVEL];
	int m_CommandFreeSkillWcoinP[MAX_ACCOUNT_LEVEL];
	int m_CommandFreePointSwitch[MAX_ACCOUNT_LEVEL];
	int m_CommandFreePointWcoinP[MAX_ACCOUNT_LEVEL];
	int m_CommandFreePointZen[MAX_ACCOUNT_LEVEL];
	int m_CommandFreeMasterSwitch[MAX_ACCOUNT_LEVEL];
	int m_CommandFreeMasterWcoinP[MAX_ACCOUNT_LEVEL];
	...
	//
	int	m_TheGift;
	int	m_TheGiftEnable[MAX_ACCOUNT_LEVEL];
	//
	...
	int	m_RolltheDiceButton;
	int	m_HeadsTailButton;
	int	m_LuckyNumberButton;
	int	m_SmithItemButton;
	int	m_TitleManagerButton;
	int	m_PartySearchSettingButton;
	int	m_OffAttackButton;
	int	m_BuyVipButton;
	int m_ChangeClassButton;
	int m_ResetPointCheckBox;
	int m_ResetPointCheckBox2;
	int	m_ResetMasterSkillCheckBox;
	int	m_ResetMasterSkillCheckBox2;
	int	m_AccountSecurityButton;
	int	m_JewelsBankButton;
	int m_RenameButton;
	int m_TopPlayerButton;
	int m_PShopCurrencyButton;
	int m_PShopOffStoreButton;
	int m_RPSModeButton;
	int m_NewsBoardButton;
	int m_FruitMainButton;
	int m_LuckySpinButton;
	int m_GiftCodeButton;
	...
	int m_wCoinCButton;
	int m_wCoinPButton;
	int m_GoblinPointButton;
	int	m_EventTimerButton;
	int	m_CustomWareButton;
	int m_PartyLeaderButton;
	int m_PartyTraceButton;
	//
	int	m_CustomResetRewardSwitch;
	//
	//Change Name
	...
	//
	int m_ServerMinUserReset;
	int m_ServerMaxUserReset;
	//
	int	m_AnnouncePlayerJoinGame;
	char m_AnnouncePlayerJoinGameText[100];
	//
	int	m_AnnouncePlayerKillPlayer;
	char m_AnnouncePlayerKillPlayerText[100];
	//Custom Interface Price
	int	ResetPointWC[MAX_ACCOUNT_LEVEL];
	int	ResetPointZEN[MAX_ACCOUNT_LEVEL];
	int	ResetMasterWC[MAX_ACCOUNT_LEVEL];
	int	ResetMasterZEN[MAX_ACCOUNT_LEVEL];
	int	ChangeNameWC[MAX_ACCOUNT_LEVEL];
	//Bypass SD
	int m_BypassShield;
	//
	...
	BYTE LuckyItemVault;
	BYTE LuckyItemTrade;
	BYTE LuckyItemAcceptJoh;
	//
	BYTE FruitOriginalWZ;
	//
	BYTE CyclonePushBack;
	//BYTE GetQuestKillOutsideParty;
	//
	DWORD m_AntihackCRC;
	DWORD m_DllCRC;
	DWORD m_MainCRC;
	DWORD m_PlayerCRC;
	//
	int m_CastleSiegeSummonRoom;
	int m_DisconnectOnConenct;
	int m_DuelMatchPoint;
	int m_DuelBetMatchPoint;
	//Event PvP
	...
	//
	int NewBroad_ShowOnLogin;
	int UsingComboSkill;
	//
	int TracePlayerPartyZen[MAX_ACCOUNT_LEVEL];
	//
	int m_PkCanEnterBC;
	int m_PkCanEnterCC;
	int m_PkCanEnterDS;
	int m_GoldenArcherNeedRena;
};

extern CServerInfo gServerInfo;
extern char g_szMapName[90][90];