...
#define MAX_INVASION 100
#define MAX_INVASION_MONSTER 500
#define MAX_INVASION_RESPAWN_GROUP 90
...
public:
	...
	void CheckGreatGoldDragon(int MapNumber);
	void CheckRedDragon(int MapNumber);
	// ----
	bool GoldDerconRegen;
	int GoldDerconMap;
	int GoldDerconCount;
	bool GGDRegen;
	int GGDMap;
