...
enum eChaosMixNumber
{
	...
	CHAOS_MIX_ARCHANGEL_HAMMER = 65,
	CHAOS_MIX_ARCHANGEL_WEAPON = 66,
	CHAOS_MIX_GARUDA_FEATHER = 68,
	CHAOS_MIX_LVL_4 = 69,
};
...
public:
	...
	void ArchangelWeaponMix(LPOBJ lpObj);
	...
	void FeatherOfGarudaMix(LPOBJ lpObj);
	void WingLvl4Mix(LPOBJ lpObj);
public:
