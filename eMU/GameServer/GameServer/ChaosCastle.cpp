...
void CChaosCastle::GiveUserRewardItem(CHAOS_CASTLE_LEVEL* lpLevel,int aIndex) // OK
{
	...
	{
		//Reward
		gCashShop.GDCashShopAddPointSaveSend(lpUser->Index,0,this->m_ChaosCastleRewardValue[lpLevel->Level][0],this->m_ChaosCastleRewardValue[lpLevel->Level][1],this->m_ChaosCastleRewardValue[lpLevel->Level][2]);
