...
public:
	...
	void InsertItem(int ItemIndex,int ItemLevel,int ItemDurability,int ItemOption1,int ItemOption2,int ItemOption3,int ItemNewOption,int AncOption,int ItemOptionEx,int Socket,int Socket2,int Socket3,int Socket4,int Socket5,int SocketBonus,int ItemValue);
	bool GetItem(CItem* lpItem,int slot);
	long GetItemCount();
	bool GCShopItemListSend(int aIndex);
	BYTE s_SocketOption[5];
private:
