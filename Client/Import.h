...
#define pLoadSomeForm			((void(__cdecl*)()) 0x00777590)
#define oLoadSomeForm_Call		0x00776EAE
...
#define pEventEffectThis		((LPVOID(__cdecl*)(int Arg1)) 0x009D00C5)
...
#define pPShopThis1				((LPVOID(__cdecl*)()) 0x00861110)
...
//#define pWarehouseClass			((int(__cdecl*)()) 0x00861110)
...
#define pGameShopGetGP			((double(__thiscall*)(LPVOID This)) 0x00940510)
#define pUserStat				((LPVOID(*)()) 0x588D70)
#define pUpdateUserStat			((void(__thiscall*)(LPVOID This, int * Value, int Code)) 0x4EA460)
#define pIsButtonPressed		((int(__thiscall*)(int ButtonNumber)) 0x00791070)
// ----------------------------------------------------------------------------------------------

//-> Other
// #define oCam_Zoom				0x0D27BFC	//1037DB0 //-> Error
...
//-> Protocol
#define oWhisperChat_Call		0x006640EE
