...
{
	//SetCompleteHook(0xE8, 0x5CF310+0xF63 ,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0xFA3 ,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0xFE3 ,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1023,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1063,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x10AE,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x10EE,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1139,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1179,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x11B9,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1212,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x123E,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x126C,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1299,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x12CE,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x130C,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1341,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1376,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x13C2,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x13EB,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1437,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1460,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x14AC,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x14D5,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1529,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1550,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1577,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x15C7,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x15EE,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x163F,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1666,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x16B8,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x16E1,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1721,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x177C,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x17BA,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x17EF,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1824,&sub_5CA0D0);
	//SetCompleteHook(0xE8, 0x5CF310+0x1856,&sub_5CA0D0);
	SetCompleteHook(0xE8, 0x5CF310+0x1884,&this->SetPosition); // Inventory
}
void cItemPosition::SetPosition(int a1, int a2, int a3, int a4, VAngle* a5, int a6, char a7)
{
	...
	//g_Console.AddMessage(4,"X = %d Y = %d", X, Y);

	//-> a6 наведён ли курсор
	//-> a7 вертится ли шмотка на курсоре

	if ( a7 )
	{
		sub_959A60_Addr(0x8793394, 0.07, (int)&v31, (int)&v28);
	}	
	else
	{
		sub_959A60_Addr(0x8793394, 0.1, (int)&v31, (int)&v28);
	}
							...
							else if ( a1 != 3241 && a1 != 3242 )
							{
								...
								case 3246:
									...
									*(float*)0x82C6328 = 25.0;
									break;
								default:
									//if (a1 == GET_ITEM_MODEL(4,100))
									if (gCustomWeapons.CheckElfBow(a1-ITEM_BASE_MODEL))
									{
										*(float*)0x82C6320 = 180.0;
										*(float*)0x82C6324 = -90.0;
										*(float*)0x82C6328 = 15.0;
									}
									else if (gCustomWeapons.CheckElfCrossbow(a1-ITEM_BASE_MODEL))
									{
										/**(float*)0x82C6320 = 0.0;
										*(float*)0x82C6324 = -90.0;
										*(float*)0x82C6328 = 15.0;*/
																			...
																			if ( a1 < 8465 || a1 > 8468 )
																			{
																				if ( a1 < 8469 || a1 > 8471 )
																				{
																					...
																					else if ( a1 != 4814 && a1 != 4838 )
																					{
																						...
																						{
																							if ( a1 != 1203 && a1 != 1211 && !gCustomWeapons.CheckRF(a1-ITEM_BASE_MODEL) )
																							{
																								if ( (a1 < 1204 || a1 > 1205) /*a1 != GET_ITEM_MODEL(0, 41)*/ ) //RF
																								{
																									if ( a1 == 7364 )
																									{
																										v28.Y = v28.Y + 0.009999999776482582;
																	...
																	if ( a1 < 8465 || a1 > 8468 )
																	{
																		if ( a1 < 8469 || a1 > 8471 )
																		{
																			...
																			else if ( a1 < 7364 || a1 > 7365 )
																			{
																				...
																				else if ( (a1 < 1203 || a1 > 1205 ) && a1 != 1211 && !gCustomWeapons.CheckRF(a1-ITEM_BASE_MODEL) ) //RF
																				{
																					if ( a1 < 8881 || a1 > 8887 )
																					{
...
LABEL_1089:
		...
		//if ( a1 == GET_ITEM_MODEL(0, 41) )
		/*
		if (gCustomWeapons.CheckElfBow(a1-ITEM_BASE_MODEL))
		{
			v28.X -= 0.05;
			v28.Y += 0.12;
			v19.m_Model.Scale *= 1.5;
		...
		*/
		...
		/*if (gCustomWeapons.CheckElfCrossbow(a1-ITEM_BASE_MODEL))
		{
			v28.X -= 0.1;
			v28.Y += 0.08; 
		}*/
