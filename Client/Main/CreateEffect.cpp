...
void CreateItemEffect(int lpModel, int ItemID, vec3_t Light, float Alpha, int ItemLevel, int NewOption, int a10, int a11, int RenderType)
{
	...
	case ITEM2(4, 30): //Blessed Crossbow
	{
		float v1161;
	...
	case ITEM2(2, 24): //Blessed Scepter
	{
		float v1160;
...
void ModelLinkObject(int a1)
{
	...
	if (a1 != -776)
	{
		...
		if (v6)
		{
			for (int i = 0; i < 2; ++i)
			{
				int v278 = a1 + 36 * i + 448;
				if (EqualItemModelType((int*)0xEBCD98, *(WORD*)v278) == ITEM2(0, 350)) //Phoenix Soul Star
				{
					if (i)
						v165 = 100.0;
					else
					...
					float v274 = -75.0;
					*(BYTE*)(v278 + 5) = 28;
					RenderLinkObject(v270, v275, v274, a1, v278, 618, 0, 0, 1, 1, 0, 1);
				}
				else if (EqualItemModelType((int*)0xEBCD98, *(WORD*)v278) == ITEM2(0, 61)) //Blessed Claw
				{
					int v154;
					if (i)
					...
					if (v154)
					{
						...
						TransformPosition(v6, v184, WorldPos, Bone, 1);
						CreateSprite(42134, Bone, 2.0, Color, v122, 0.0, 0);
						Vector(-62.0, 26.0, -7.0, WorldPos);
						TransformPosition(v6, v184, WorldPos, Bone, 1);
						CreateSprite(42134, Bone, 0.60000002, Color, v122, 0.0, 0);
						Vector(-49.0, 30.0, -22.0, WorldPos);
						TransformPosition(v6, v184, WorldPos, Bone, 1);
						CreateSprite(42134, Bone, 1.1, Color, v122, 0.0, 0);
						Vector(-52.0, 24.0, 15.0, WorldPos);
						TransformPosition(v6, v184, WorldPos, Bone, 1);
						CreateSprite(42134, Bone, 1.1, Color, v122, 0.0, 0);
						Vector(-34.0, 18.0, -22.0, WorldPos);
						TransformPosition(v6, v184, WorldPos, Bone, 1);
						CreateSprite(42134, Bone, 0.80000001, Color, v122, 0.0, 0);
						Vector(-41.0, 15.0, 15.0, WorldPos);
						TransformPosition(v6, v184, WorldPos, Bone, 1);
						CreateSprite(42134, Bone, 0.80000001, Color, v122, 0.0, 0);
						Vector(0.0, -2.0, 2.0, WorldPos);
						TransformPosition(v6, v184, WorldPos, Bone, 1);
						CreateSprite(42134, Bone, 2.5999999, Color, v122, 0.0, 0);
						Vector(v183 * 0.69999999, v183 * 0.5, v183 * 0.15000001, Color);
						float v149 = ((int)*(float*)0x5EF5A1C % 360) * 0.05000000074505806;
						CreateSprite(32280, Bone, 0.23, Color, v122, v149, 0);
					}
				}
			}
		}
