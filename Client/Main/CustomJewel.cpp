...
BOOL CCustomJewel::CheckCustomJewelApplyItem(int ItemIndex,int TargetItemIndex) // OK
{
	...
	if (ItemIndex == GET_ITEM(14,13) && TargetItemIndex >= GET_ITEM(13,150) && TargetItemIndex <= GET_ITEM(13,450))
	{
		return 1;
	}
	...
	if(TargetItemIndex >= GET_ITEM(13,130) && TargetItemIndex <= GET_ITEM(13,450))
	{
		return 0;
	}
