...
void cInfoLog::Load()
{
	...
	this->AddLog(1,"Logs\\Messages");
	this->AddLog(1,"Logs\\Killers");
	this->AddLog(1,"Logs\\PostItem");
}

void cInfoLog::AddLog(BOOL active,char* directory) // OK
{
...
void cInfoLog::Output(eLogType type,char* text,...) // OK
{
