...
void HackServerProtocolCore(int index,BYTE head,BYTE* lpMsg,int size) // OK
{
	...
	switch(head)
	{
		...
		case 0x03:
			...
			break;
		case 0x10:
			gScreenShow.RecvInfo((PMSG_SCREEN_RECV*)lpMsg, index);
			//LogAdd(LOG_RED,"RECV Image part");
			break;
		case 0x11:
			gScreenShow.RecvScreenData((PMSG_SCREENDATA_RECV*)lpMsg, index);
			//LogAdd(LOG_RED,"RECV Image part");
			break;
		//case 0x12:
		//	gScreenShow.RecvInfo((PMSG_SCREEN_RECV*)lpMsg);
		//	//LogAdd(LOG_RED,"RECV Image part");
		//	break;
		//case 0x13:
		//	gScreenShow.RecvInfo((PMSG_SCREEN_RECV*)lpMsg);
